  ...
  const expertiseAreas = [
    {
      ...
      description: 'Leading BetaFix with innovative strategies and business development. Driving growth through data-driven decisions and market analysis.',
      skills: ['Strategic Planning', 'Team Leadership', 'Business Development', 'Market Analysis'],
      achievements: ['50% Revenue Growth', '25+ Team Members', 'Market Expansion'],
    ...
    },
    {
      ...
      description: 'Professional trading with focus on technical analysis and risk management. Consistent returns through disciplined strategies.',
    ...
    },
    {
      ...
      description: 'Building modern, responsive web applications with React. Focus on performance, user experience, and clean, maintainable code.',
